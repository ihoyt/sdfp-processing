...
def main():
    ...
    try:
        new_data = pd.read_sql_query("SELECT * FROM sensor_data WHERE processed = 'FALSE' AND pressure > 800 AND date < '2022-11-15'", engine).sort_values(['place','date']).drop_duplicates()
