...
def main():
    ...
    try:
        new_data = pd.read_sql_query("SELECT * FROM sensor_data WHERE processed = 'FALSE' AND pressure > 800 AND sensor_data.sensor_ID='BF_01'", engine).sort_values(['place','date']).drop_duplicates()
